...
#include <glm/glm.hpp>
#include <glm/gtc/type_ptr.hpp> //delete later
...
///headers from shaderGL.h :

//OpenGL program wrapper
class Shader
{
public:
	Shader(const char *vsource = NULL, const char *fsource = NULL, const char* gsource = NULL);
	~Shader() = default;
	...
	void SetVec2(glm::vec2 value, const GLchar* name);
	void SetVec3(glm::vec3 value, const GLchar* name);
	void SetVec4(glm::vec4 value, const GLchar* name);
	void SetMat3(glm::mat3 value, const GLchar* name, GLboolean transpose = GL_FALSE);
